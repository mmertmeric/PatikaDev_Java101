...
public class JavaPatika {
    ...
    static void plus() {
        ...
        while (true) {
            System.out.print(i++ + ". sayı : (0 yazarsan işlem biter)");
            number = scan.nextInt();
            if (number == 0) {
                break;
            }
    ...
    static void times() {
        ...
        while (true) {
            System.out.print(i++ + ". sayı : (1 yazarsan biter)");
            number = scan.nextInt();
    ...
    static void mod() {
        ...
        System.out.println(ilk+ " sayısının " + iki + " den kalanı " + mod + "dur");
